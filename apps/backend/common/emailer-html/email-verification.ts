                    ...
                    <tr>
                        <td style="padding: 40px;">
                            ...
                            <div style="margin-bottom: 30px;">
                               <img src="https://cleanlysport.com/favicon.ico" alt="Cleanly Sports logo" width="30" height="30" style="display: block; filter: brightness(0) invert(1);">
                            </div>

                            <h1 style="color: #ffffff; font-size: 20px; font-weight: 500; margin: 0 0 20px 0;">
                                Hello, welcome to Cleanly Sports!
                            </h1>
                            ...
                            <p style="color: #cccccc; font-size: 16px; line-height: 1.6; margin: 40px 0 30px 0;">
                                Cleanly Sports is a Fast, AI-powered guidance for athletes navigating supplements and medications
                            </p>
                            ...
                            <p style="color: #888888; font-size: 14px; margin: 0;">
                                To learn more about Cleanly Sports and all its features, check out our Cleanly Sports Website: 
                                <a href="https://cleanlysport.com" style="color: #888888; text-decoration: underline;">https://cleanlysport.com</a>
                            </p>
